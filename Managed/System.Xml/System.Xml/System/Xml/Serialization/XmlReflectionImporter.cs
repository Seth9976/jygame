...
namespace System.Xml.Serialization
{
	...
	public class XmlReflectionImporter
	{
		...
		// Token: 0x06001AD9 RID: 6873 RVA: 0x0008B0A8 File Offset: 0x000892A8
		...
		// Token: 0x06001ADA RID: 6874 RVA: 0x0008B0B4 File Offset: 0x000892B4
		...
		// Token: 0x06001ADB RID: 6875 RVA: 0x0008B0C0 File Offset: 0x000892C0
		...
		/// <param name="attributeOverrides">An object that overrides how the <see cref="T:System.Xml.Serialization.XmlSerializer" /> class serializes mapped types.</param>
		/// <param name="defaultNamespace">The default XML namespace to use for imported type mappings.</param>
		// Token: 0x06001ADC RID: 6876 RVA: 0x0008B0CC File Offset: 0x000892CC
		...
		// (get) Token: 0x06001ADE RID: 6878 RVA: 0x0008B150 File Offset: 0x00089350
		// (set) Token: 0x06001ADF RID: 6879 RVA: 0x0008B158 File Offset: 0x00089358
		...
		// Token: 0x06001AE0 RID: 6880 RVA: 0x0008B164 File Offset: 0x00089364
		...
		// Token: 0x06001AE1 RID: 6881 RVA: 0x0008B174 File Offset: 0x00089374
		[MonoTODO]
		...
		// Token: 0x06001AE2 RID: 6882 RVA: 0x0008B184 File Offset: 0x00089384
		[MonoTODO]
		...
		// Token: 0x06001AE3 RID: 6883 RVA: 0x0008B1A4 File Offset: 0x000893A4
		[MonoTODO]
		public XmlMembersMapping ImportMembersMapping(string elementName, string ns, XmlReflectionMember[] members, bool hasWrapperElement, bool writeAccessors, bool validate, XmlMappingAccess access)
		{
			...
			{
				XmlTypeMapMember xmlTypeMapMember = this.CreateMapMember(null, members[i], ns);
				array[i] = new XmlMemberMapping(members[i].MemberName, ns, xmlTypeMapMember, false);
			}
		...
		// Token: 0x06001AE4 RID: 6884 RVA: 0x0008B270 File Offset: 0x00089470
		...
		// Token: 0x06001AE5 RID: 6885 RVA: 0x0008B27C File Offset: 0x0008947C
		...
		// Token: 0x06001AE6 RID: 6886 RVA: 0x0008B288 File Offset: 0x00089488
		...
		/// <param name="root">An <see cref="T:System.Xml.Serialization.XmlRootAttribute" /> attribute that is applied to the type.</param>
		/// <param name="defaultNamespace">The default XML namespace to use.</param>
		// Token: 0x06001AE7 RID: 6887 RVA: 0x0008B294 File Offset: 0x00089494
		...
		// Token: 0x06001AE8 RID: 6888 RVA: 0x0008B2EC File Offset: 0x000894EC
		...
		// Token: 0x06001AE9 RID: 6889 RVA: 0x0008B2F8 File Offset: 0x000894F8
		private XmlTypeMapping ImportTypeMapping(TypeData typeData, XmlRootAttribute root, string defaultNamespace)
		{
			...
			{
				throw new InvalidOperationException(string.Format(CultureInfo.InvariantCulture, "There was an error reflecting type '{0}'.", new object[] { typeData.Type.FullName }), ex);
			}
			return xmlTypeMapping2;
		}

		// Token: 0x06001AEA RID: 6890 RVA: 0x0008B4CC File Offset: 0x000896CC
		private XmlTypeMapping CreateTypeMapping(TypeData typeData, XmlRootAttribute root, string defaultXmlType, string defaultNamespace)
		{
			...
			if (xmlAttributes.XmlType != null)
			{
				...
				flag = xmlAttributes.XmlType.IncludeInSchema;
			}
			string text3 = defaultXmlType;
			if (root != null)
			{
				if (root.ElementName.Length != 0)
				{
					text3 = XmlConvert.EncodeLocalName(root.ElementName);
				}
			...
			if (schemaType != SchemaTypes.Primitive)
			{
				...
				{
					xmlTypeMapping = new XmlTypeMapping(text3, text, typeData, defaultXmlType, text2);
				}
				else
				{
					xmlTypeMapping = new XmlSerializableMapping(text3, text, typeData, defaultXmlType, text2);
				}
			}
			else if (!typeData.IsXsdType)
			{
				xmlTypeMapping = new XmlTypeMapping(text3, text, typeData, defaultXmlType, "http://microsoft.com/wsdl/types/");
			}
			else
			{
				xmlTypeMapping = new XmlTypeMapping(text3, text, typeData, defaultXmlType, text2);
			...
			xmlTypeMapping.IsNullable = flag2;
			this.relatedMaps.Add(xmlTypeMapping);
			return xmlTypeMapping;
		}

		// Token: 0x06001AEB RID: 6891 RVA: 0x0008B6D4 File Offset: 0x000898D4
		...
		// Token: 0x06001AEC RID: 6892 RVA: 0x0008B6F4 File Offset: 0x000898F4
		private XmlTypeMapping ImportClassMapping(TypeData typeData, XmlRootAttribute root, string defaultNamespace)
		{
			...
			foreach (object obj in reflectionMembers)
			{
				...
				string text = xmlTypeMapping.XmlTypeNamespace;
				if (!xmlReflectionMember.XmlAttributes.XmlIgnore)
				{
					if (xmlReflectionMember.DeclaringType != null && xmlReflectionMember.DeclaringType != type)
					{
						...
						text = xmlTypeMapping2.XmlTypeNamespace;
					}
					try
					{
						XmlTypeMapMember xmlTypeMapMember = this.CreateMapMember(type, xmlReflectionMember, text);
						xmlTypeMapMember.CheckOptionalValueType(type);
						classMap.AddMember(xmlTypeMapMember);
					}
					catch (Exception ex)
					{
						throw new InvalidOperationException(string.Format(CultureInfo.InvariantCulture, "There was an error reflecting field '{0}'.", new object[] { xmlReflectionMember.MemberName }), ex);
					}
				}
			}
		...
		// Token: 0x06001AED RID: 6893 RVA: 0x0008BAA0 File Offset: 0x00089CA0
		...
		// Token: 0x06001AEE RID: 6894 RVA: 0x0008BB10 File Offset: 0x00089D10
		...
		// Token: 0x06001AEF RID: 6895 RVA: 0x0008BC04 File Offset: 0x00089E04
		...
		// Token: 0x06001AF0 RID: 6896 RVA: 0x0008BC28 File Offset: 0x00089E28
		...
		// Token: 0x06001AF1 RID: 6897 RVA: 0x0008C10C File Offset: 0x0008A30C
		...
		// Token: 0x06001AF2 RID: 6898 RVA: 0x0008C19C File Offset: 0x0008A39C
		...
		// Token: 0x06001AF3 RID: 6899 RVA: 0x0008C1F0 File Offset: 0x0008A3F0
		private XmlTypeMapping ImportEnumMapping(TypeData typeData, XmlRootAttribute root, string defaultNamespace)
		{
			...
			foreach (string text in names)
			{
				...
				if (!field.IsDefined(typeof(XmlIgnoreAttribute), false))
				{
					...
					arrayList.Add(new EnumMap.EnumMapMember(text2, text, num));
				}
			}
			bool flag = type.IsDefined(typeof(FlagsAttribute), false);
			xmlTypeMapping.ObjectMap = new EnumMap((EnumMap.EnumMapMember[])arrayList.ToArray(typeof(EnumMap.EnumMapMember)), flag);
			this.ImportTypeMapping(typeof(object)).DerivedTypes.Add(xmlTypeMapping);
			return xmlTypeMapping;
		}

		// Token: 0x06001AF4 RID: 6900 RVA: 0x0008C368 File Offset: 0x0008A568
		...
		// Token: 0x06001AF5 RID: 6901 RVA: 0x0008C3CC File Offset: 0x0008A5CC
		...
		// Token: 0x06001AF6 RID: 6902 RVA: 0x0008C418 File Offset: 0x0008A618
		...
		// Token: 0x06001AF7 RID: 6903 RVA: 0x0008C730 File Offset: 0x0008A930
		...
		// Token: 0x06001AF8 RID: 6904 RVA: 0x0008CC94 File Offset: 0x0008AE94
		private XmlTypeMapElementInfoList ImportElementInfo(Type cls, string defaultName, string defaultNamespace, Type defaultType, XmlTypeMapMemberElement member, XmlAttributes atts)
		{
			...
			if (atts.XmlChoiceIdentifier != null)
			{
				...
				if (member2.Length == 0)
				{
					throw new InvalidOperationException(string.Concat(new object[] { "Choice member '", member.ChoiceMember, "' not found in class '", cls }));
				}
			...
			foreach (object obj in atts.XmlElements)
			{
				...
				if (enumMap != null)
				{
					...
					if (enumName == null)
					{
						throw new InvalidOperationException(string.Format(CultureInfo.InvariantCulture, "Type {0} is missing enumeration value '{1}' for element '{1} from namespace '{2}'.", new object[] { type, xmlTypeMapElementInfo2.ElementName, xmlTypeMapElementInfo2.Namespace }));
					}
		...
		// Token: 0x06001AF9 RID: 6905 RVA: 0x0008D0F8 File Offset: 0x0008B2F8
		private XmlTypeMapElementInfoList ImportAnyElementInfo(string defaultNamespace, XmlReflectionMember rmember, XmlTypeMapMemberElement member, XmlAttributes atts)
		{
			...
			foreach (object obj in atts.XmlAnyElements)
			{
				...
				else
				{
					...
					{
						throw new InvalidOperationException(string.Concat(new string[] { "The element ", rmember.MemberName, " has been attributed with an XmlAnyElementAttribute and a namespace '", xmlAnyElementAttribute.Namespace, "', but no name. When a namespace is supplied, a name is also required. Supply a name or remove the namespace." }));
					}
				}
				xmlTypeMapElementInfoList.Add(xmlTypeMapElementInfo);
			}
		...
		// Token: 0x06001AFA RID: 6906 RVA: 0x0008D238 File Offset: 0x0008B438
		...
		// Token: 0x06001AFB RID: 6907 RVA: 0x0008D384 File Offset: 0x0008B584
		...
		// Token: 0x06001AFC RID: 6908 RVA: 0x0008D3A0 File Offset: 0x0008B5A0
		...
		// Token: 0x06001AFD RID: 6909 RVA: 0x0008D498 File Offset: 0x0008B698
		...
		// Token: 0x06001AFE RID: 6910 RVA: 0x0008D4E4 File Offset: 0x0008B6E4
		private object GetDefaultValue(TypeData typeData, object defaultValue)
		{
			...
			if (text == text2)
			{
				string text3 = string.Format(CultureInfo.InvariantCulture, "Value '{0}' cannot be converted to {1}.", new object[]
				{
					defaultValue,
