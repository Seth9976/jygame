...
namespace UnityEngine.Networking
{
	...
	{
		// Token: 0x060002E8 RID: 744 RVA: 0x0000E16C File Offset: 0x0000C36C
		private void Awake()
		{
			this.manager = base.GetComponent<NetworkManager>();
		}

		// Token: 0x060002E9 RID: 745 RVA: 0x0000E17C File Offset: 0x0000C37C
		private void Update()
		{
			if (!this.showGUI)
			{
		...
		// Token: 0x060002EA RID: 746 RVA: 0x0000E240 File Offset: 0x0000C440
		private void OnGUI()
		{
			if (!this.showGUI)
			{
