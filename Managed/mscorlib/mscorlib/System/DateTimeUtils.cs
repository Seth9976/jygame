...
namespace System
{
	...
	{
		// Token: 0x060010B2 RID: 4274 RVA: 0x000442EC File Offset: 0x000424EC
		...
		// Token: 0x060010B3 RID: 4275 RVA: 0x00044324 File Offset: 0x00042524
		...
		// Token: 0x060010B4 RID: 4276 RVA: 0x00044390 File Offset: 0x00042590
		...
		// Token: 0x060010B5 RID: 4277 RVA: 0x0004441C File Offset: 0x0004261C
		...
		// Token: 0x060010B6 RID: 4278 RVA: 0x00044428 File Offset: 0x00042628
		public static string GetStandardPattern(char format, DateTimeFormatInfo dfi, out bool useutc, out bool use_invariant, bool date_time_offset)
		{
			...
			case 'r':
				goto IL_0144;
			case 's':
				text = dfi.SortableDateTimePattern;
				use_invariant = true;
				return text;
			case 't':
				return dfi.ShortTimePattern;
			case 'u':
				text = dfi.UniversalSortableDateTimePattern;
				if (date_time_offset)
				{
					useutc = true;
				}
			...
			IL_0135:
			text = dfi.RoundtripPattern;
			use_invariant = true;
			return text;
			IL_0144:
			text = dfi.RFC1123Pattern;
			if (date_time_offset)
			{
				useutc = true;
			}
			...
			return text;
			IL_01BA:
			text = dfi.YearMonthPattern;
			return text;
		}

		// Token: 0x060010B7 RID: 4279 RVA: 0x00044604 File Offset: 0x00042804
		...
		// Token: 0x060010B8 RID: 4280 RVA: 0x00044624 File Offset: 0x00042824
