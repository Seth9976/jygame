...
namespace System.Text
{
	...
	public class ASCIIEncoding : Encoding
	{
		...
		// Token: 0x06003E85 RID: 16005 RVA: 0x000D67C4 File Offset: 0x000D49C4
		...
		// (get) Token: 0x06003E86 RID: 16006 RVA: 0x000D6814 File Offset: 0x000D4A14
		[ComVisible(false)]
		...
		/// <filterpriority>1</filterpriority>
		// Token: 0x06003E87 RID: 16007 RVA: 0x000D6818 File Offset: 0x000D4A18
		...
		/// <exception cref="T:System.Text.EncoderFallbackException">A fallback occurred (see Understanding Encodings for complete explanation)-and-<see cref="P:System.Text.Encoding.EncoderFallback" /> is set to <see cref="T:System.Text.EncoderExceptionFallback" />.</exception>
		/// <filterpriority>1</filterpriority>
		// Token: 0x06003E88 RID: 16008 RVA: 0x000D6884 File Offset: 0x000D4A84
		...
		/// <exception cref="T:System.Text.EncoderFallbackException">A fallback occurred (see Understanding Encodings for complete explanation)-and-<see cref="P:System.Text.Encoding.EncoderFallback" /> is set to <see cref="T:System.Text.EncoderExceptionFallback" />.</exception>
		/// <filterpriority>1</filterpriority>
		// Token: 0x06003E89 RID: 16009 RVA: 0x000D68A0 File Offset: 0x000D4AA0
		...
		// Token: 0x06003E8A RID: 16010 RVA: 0x000D68C4 File Offset: 0x000D4AC4
		...
		/// <exception cref="T:System.Text.EncoderFallbackException">A fallback occurred (see Understanding Encodings for complete explanation)-and-<see cref="P:System.Text.Encoding.EncoderFallback" /> is set to <see cref="T:System.Text.EncoderExceptionFallback" />.</exception>
		/// <filterpriority>1</filterpriority>
		// Token: 0x06003E8B RID: 16011 RVA: 0x000D6A84 File Offset: 0x000D4C84
		...
		// Token: 0x06003E8C RID: 16012 RVA: 0x000D6AA8 File Offset: 0x000D4CA8
		...
		/// <filterpriority>1</filterpriority>
		// Token: 0x06003E8D RID: 16013 RVA: 0x000D6C78 File Offset: 0x000D4E78
		...
		/// <exception cref="T:System.Text.DecoderFallbackException">A fallback occurred (see Understanding Encodings for complete explanation)-and-<see cref="P:System.Text.Encoding.DecoderFallback" /> is set to <see cref="T:System.Text.DecoderExceptionFallback" />.</exception>
		/// <filterpriority>1</filterpriority>
		// Token: 0x06003E8E RID: 16014 RVA: 0x000D6CE4 File Offset: 0x000D4EE4
		...
		// Token: 0x06003E8F RID: 16015 RVA: 0x000D6D04 File Offset: 0x000D4F04
		...
		/// <filterpriority>1</filterpriority>
		// Token: 0x06003E90 RID: 16016 RVA: 0x000D6E44 File Offset: 0x000D5044
		...
		/// <filterpriority>1</filterpriority>
		// Token: 0x06003E91 RID: 16017 RVA: 0x000D6E64 File Offset: 0x000D5064
		...
		/// <exception cref="T:System.Text.DecoderFallbackException">A fallback occurred (see Understanding Encodings for complete explanation)-and-<see cref="P:System.Text.Encoding.DecoderFallback" /> is set to <see cref="T:System.Text.DecoderExceptionFallback" />.</exception>
		/// <filterpriority>1</filterpriority>
		// Token: 0x06003E92 RID: 16018 RVA: 0x000D6E84 File Offset: 0x000D5084
		...
		/// <exception cref="T:System.Text.EncoderFallbackException">A fallback occurred (see Understanding Encodings for complete explanation)-and-<see cref="P:System.Text.Encoding.EncoderFallback" /> is set to <see cref="T:System.Text.EncoderExceptionFallback" />.</exception>
		/// <filterpriority>1</filterpriority>
		// Token: 0x06003E93 RID: 16019 RVA: 0x000D6F70 File Offset: 0x000D5170
		[CLSCompliant(false)]
		[ComVisible(false)]
		...
		/// <exception cref="T:System.Text.DecoderFallbackException">A fallback occurred (see Understanding Encodings for complete explanation)-and-<see cref="P:System.Text.Encoding.DecoderFallback" /> is set to <see cref="T:System.Text.DecoderExceptionFallback" />.</exception>
		/// <filterpriority>1</filterpriority>
		// Token: 0x06003E94 RID: 16020 RVA: 0x000D7010 File Offset: 0x000D5210
		[ComVisible(false)]
		[CLSCompliant(false)]
		...
		/// <exception cref="T:System.Text.DecoderFallbackException">A fallback occurred (see Understanding Encodings for complete explanation)-and-<see cref="P:System.Text.Encoding.DecoderFallback" /> is set to <see cref="T:System.Text.DecoderExceptionFallback" />.</exception>
		/// <filterpriority>1</filterpriority>
		// Token: 0x06003E95 RID: 16021 RVA: 0x000D70AC File Offset: 0x000D52AC
		[CLSCompliant(false)]
		[ComVisible(false)]
		...
		/// <exception cref="T:System.Text.EncoderFallbackException">A fallback occurred (see Understanding Encodings for complete explanation)-and-<see cref="P:System.Text.Encoding.EncoderFallback" /> is set to <see cref="T:System.Text.EncoderExceptionFallback" />.</exception>
		/// <filterpriority>1</filterpriority>
		// Token: 0x06003E96 RID: 16022 RVA: 0x000D70B0 File Offset: 0x000D52B0
		[ComVisible(false)]
		[CLSCompliant(false)]
		...
		/// <filterpriority>1</filterpriority>
		// Token: 0x06003E97 RID: 16023 RVA: 0x000D70B4 File Offset: 0x000D52B4
		[ComVisible(false)]
		...
		/// <filterpriority>1</filterpriority>
		// Token: 0x06003E98 RID: 16024 RVA: 0x000D70BC File Offset: 0x000D52BC
		[ComVisible(false)]
		[MonoTODO("we have simple override to match method signature.")]
