...
namespace System.Text
{
	...
	public abstract class Decoder
	{
		...
		// (get) Token: 0x06003EA0 RID: 16032 RVA: 0x000D7290 File Offset: 0x000D5490
		// (set) Token: 0x06003EA1 RID: 16033 RVA: 0x000D7298 File Offset: 0x000D5498
		[ComVisible(false)]
		...
		// (get) Token: 0x06003EA2 RID: 16034 RVA: 0x000D72B4 File Offset: 0x000D54B4
		[ComVisible(false)]
		...
		/// <exception cref="T:System.Text.DecoderFallbackException">A fallback occurred (see Understanding Encodings for fuller explanation)-and-<see cref="P:System.Text.Decoder.Fallback" /> is set to <see cref="T:System.Text.DecoderExceptionFallback" />.</exception>
		/// <filterpriority>2</filterpriority>
		// Token: 0x06003EA5 RID: 16037 RVA: 0x000D72E4 File Offset: 0x000D54E4
		[ComVisible(false)]
		...
		/// <exception cref="T:System.Text.DecoderFallbackException">A fallback occurred (see Understanding Encodings for fuller explanation)-and-<see cref="P:System.Text.Decoder.Fallback" /> is set to <see cref="T:System.Text.DecoderExceptionFallback" />.</exception>
		/// <filterpriority>2</filterpriority>
		// Token: 0x06003EA6 RID: 16038 RVA: 0x000D72FC File Offset: 0x000D54FC
		[ComVisible(false)]
		[CLSCompliant(false)]
		...
		/// <exception cref="T:System.Text.DecoderFallbackException">A fallback occurred (see Understanding Encodings for fuller explanation)-and-<see cref="P:System.Text.Decoder.Fallback" /> is set to <see cref="T:System.Text.DecoderExceptionFallback" />.</exception>
		/// <filterpriority>2</filterpriority>
		// Token: 0x06003EA7 RID: 16039 RVA: 0x000D734C File Offset: 0x000D554C
		...
		/// <exception cref="T:System.Text.DecoderFallbackException">A fallback occurred (see Understanding Encodings for fuller explanation)-and-<see cref="P:System.Text.Decoder.Fallback" /> is set to <see cref="T:System.Text.DecoderExceptionFallback" />.</exception>
		/// <filterpriority>2</filterpriority>
		// Token: 0x06003EA8 RID: 16040 RVA: 0x000D7388 File Offset: 0x000D5588
		[ComVisible(false)]
		[CLSCompliant(false)]
		...
		/// <filterpriority>2</filterpriority>
		// Token: 0x06003EA9 RID: 16041 RVA: 0x000D73DC File Offset: 0x000D55DC
		[ComVisible(false)]
		...
		/// <exception cref="T:System.Text.DecoderFallbackException">A fallback occurred (see Understanding Encodings for fuller explanation)-and-<see cref="P:System.Text.Decoder.Fallback" /> is set to <see cref="T:System.Text.DecoderExceptionFallback" />.</exception>
		/// <filterpriority>2</filterpriority>
		// Token: 0x06003EAA RID: 16042 RVA: 0x000D73F4 File Offset: 0x000D55F4
		[CLSCompliant(false)]
		[ComVisible(false)]
		...
		/// <exception cref="T:System.Text.DecoderFallbackException">A fallback occurred (see Understanding Encodings for fuller explanation)-and-<see cref="P:System.Text.Decoder.Fallback" /> is set to <see cref="T:System.Text.DecoderExceptionFallback" />.</exception>
		/// <filterpriority>2</filterpriority>
		// Token: 0x06003EAB RID: 16043 RVA: 0x000D745C File Offset: 0x000D565C
		[ComVisible(false)]
		...
		// Token: 0x06003EAC RID: 16044 RVA: 0x000D74F0 File Offset: 0x000D56F0
		...
		// Token: 0x06003EAD RID: 16045 RVA: 0x000D752C File Offset: 0x000D572C
		...
		// Token: 0x06003EAE RID: 16046 RVA: 0x000D7584 File Offset: 0x000D5784
